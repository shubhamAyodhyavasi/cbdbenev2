...
const Banner = ({
    ...
    return (
        <div className={className}>
            {image2x && <img className="c-banner__bg" srcSet={`${image2x} 2x, ${image || image2x} 1x`} src={image} alt={imgAlt ? imgAlt : "banner"}/>}
            {!image2x && <img className="c-banner__bg" src={image} alt={imgAlt ? imgAlt : "banner"}/>}
