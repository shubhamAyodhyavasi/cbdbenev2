...
const CartItem = ({title, subTitle, price, quantity, onRemove, onQtyChange, total, parentClass, versions, isDisabled, ...props}) => {
        ...
        <div className={className}>
            ...
            <div className="row c-cart-item__row">
                <div className="col c-cart-item__quantity-wrapper">
                    <Quantity min={1} isDisabled={isDisabled} onChange={onQtyChange} value={quantity} parentClass="c-cart-item" />
                </div>
                <div className="col c-cart-item__price-wrapper flex-grow-0">
                    <Heading parentClass="c-cart-item" versions={["default", "white"]} subHeading={true} >
                        {price}
