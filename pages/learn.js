  ...
  render() {
    ...
    const learnSubData = {
      "1_1": (
        <div>
          <p>
          CBD, or Cannabidiol, is one of the compounds found in the Cannabis plant which the plant naturally produces. The other well-known compound is tetrahydrocannabinol (THC). THC and CBD are both Cannabinoids, occurring naturally in the cannabis plant. Hemp and Marijuana are two very different strains of the cannabis plant. However, CBD (cannabidiol) does not produce any intoxicating or “high” effects, meaning users can experience its benefits without disconcerting feelings of lethargy or dysphoria.{" "}
          </p>
          ...
          >
            CBD can be extracted from marijuana flowers or from hemp leaves. But, just to be clear, our CBD comes from solely from the Hemp plant ONLY as hemp plants produce more CBD and contain less than 0.3% THC. This single difference is what distinguishes hemp from marijuana. 
          </LearnCollapsePlus>
          ...
          >
           In contrast to THC, which is known for its psychoactive qualities, CBD is the ingredient that expressly does not produce a high. In fact, CBD provides many benefits that are commonly sought after, for a variety of healing and soothing purposes.
          </LearnCollapsePlus>
        </div>
      ),
      "1_2": (
        <div>
          ...
          >
             For starters, it has way too many syllables. But it’s similar to how research on morphine led to the discovery of endogenous morphine-like chemicals, which we know as endorphins (‘endo’ meaning). And our bodies have endogenous cannabinoids and cannabinoid receptors. So, it was named the Endocannabinoid System, or ECS, which is a network of receptors throughout the body that interact with cannabinoids.
          ...
          >
            The human body's ECS is responsible for maintaining balance and essential regulatory functions like sleep, mood, and memory. The ECS relies on the natural production of endogenous cannabinoids in order to function properly. Sometimes we need to supplement our endogenous cannabinoids with cannabinoids from external sources, such as CBD. When you ingest CBD, it stimulates the ECS which in turn helps to restore balance and maintain homeostasis.
          </LearnCollapsePlus>
        </div>
      ),
      "1_3": (
        <div>
          ...
          >
           By interacting with the receptors involved in regulating our mood, CBD can greatly contribute to how your mind perceives its current situation, and can have a significant impact on how you feel!
      ...
      "1_4": (
        <div>
          ...
          <p>
          Marijuana and hemp are both members of the cannabis family but Hemp is a form of cannabis (sativa).  Like cousins, they do share some characteristics. However, they are not the same thing.
          </p>
          
          <p>
          The difference being- The amount of psychoactive Tetrahydrocannabinol (THC) each plant produces. Hemp contains no more than 0.3 percent THC. Marijuana contains up to 30 percent THC. And that’s a huge difference. 
          </p>
          <p>
          Marijuana can get you really high, while hemp has such a low amount of THC, that it would be is impossible to get high off it. This means bene CBD will not get you high. 

          </p>
          <p>Because hemp has no psychoactive effects, the law has no problem with it. It’s legal.
</p>
          <LearnCollapsePlus
          ...
          >
           If we’re talking about hemp-derived CBD, then the answer is yes. Now, the keyword here is “hemp-derived.” Because CBD from hemp has no psychoactive effects, the purchase, sale, or possession of hemp CBD products are completely legal in all 50 states in the US. Because hemp is sometimes confused with the marijuana plant, there is still some stigma towards hemp-derived CBD, but from a legal perspective, hemp-derived CBD is completely legal and benefits from enjoys the rights of any other legal product.
          </LearnCollapsePlus>
        </div>
      ),
      "1_5": (
        <div>
          ...
          >
            Most issues have concerned the CBD manufacturing companies. As for individual consumers, it is highly unlikely that law enforcement would even bother to ask that person to take a drug test. Law enforcement agencies are focused on the manufacturers of CBD and are unlikely to bother individual customers. CBD usage is not considered drug usage. In any case, only extremely high doses of CBD (over 1000+ mg a day on a frequent basis) would give a positive result. A modest amount of CBD won't change how you walk, talk, drive, or solve differential equations. For specific questions you can always consult our doctors.
...
To be considered legal in the US, CBD products must be derived from industrial hemp which contains less than .3% THC, or “trace amounts.” These trace amounts generally aren't enough THC to show up on a basic drug test, but it is not impossible. To have a significant amount of THC in your system, you would have to consume an EXTREMELY large dose- potentially over 30–40 times the suggested daily dosage. Usually CBD never shows up on a drug test however, Drug tests vary as to what compounds are being analyzed, so we are unable to make any claims or guarantees regarding use of our products and drug tests.
      ...
      "1_6": (
        <div>
          <p>
          CBD is extracted from flowers, leaves, and the stalk of the hemp plant using solvents such as CO2, Ethanol and Olive Oil. During the extraction process, CBD is mixed with carrier oil such as hemp seed oil or coconut oil. We extract CBD by keeping the THC content in the extraction far lower than 0.3%. Hence, the resulting CBD oil is legal in all 50 states in the U.S.
          ...
          >
          Our Hemp growing conditions are safe and administered to ensure you’re getting a clean, and safe product. The growing conditions of the soil, overall environment, and extraction methods is monitored sincerely as hemp is known to absorb toxic spills, pesticides, and other dangerous chemicals that you don’t want to be ingesting.
          </LearnCollapsePlus>
          <LearnCollapsePlus
          ...
          >
           Supercritical CO2 extraction is the most advanced extraction technique resulting in a safe, clean and high-quality CBD Oil. Solid, pressurized CO2 (dry ice) is pumped through the hemp extracting the oil. CO2 extraction prevents thermal degradation and helps retain more terpenes and cannabinoids in the oil. The result is a high-quality, full spectrum CBD oil.
          ...
          >
           Ethanol solvent is run through the hemp plant material stripping it of the cannabinoids. Ethanol liquid is then evaporated. This extraction method destroys some of the beneficial cannabinoids and chlorophyll which may have health benefits. While Ethanol extraction is faster and less expensive the resulting CBD Oil is of lower quality when compared to CO2 extraction.
          ...
          >
            Olive oil extraction requires that the raw hemp plant is first heated (decarboxylated). Then, the olive oil is added and the mixture further heated to extract the cannabinoids. Olive oil cannot be evaporated away after the extraction. This process is simple and inexpensive, but the infused olive oil is highly perishable and thus impractical for commercial CBD producers.
      ...
      "1_7": (
        <div>
          <p>
          Dosing is highly personalized and depends on age, weight, and many other factors and one should experiment with finding their own dosage that suits them best. Whether ingesting oils or capsules, using a skin cream or edible items, the general guideline are to start with a low amount, gauge the effects and go slowly. Simply put, don’t go diving into the deep end. 
CBD dosing experiments have shown that small doses of CBD have a moderately ‘active’ effect, which means that a modest amount of CBD is better for focus than a higher amount. Interestingly, large dosages can have a slightly sedative effect. More research is needed to show exactly what the optimal dosage for anti-anxiety and antidepressant effects is. 
      ...
      "1_8": (
        <div>
          <p>
          It’s totally okay to experiment with our hemp-derived CBD. But because of the confusion between CBD and THC, there’s a big ol' gray area to contend with. THC is in high quantities in marijuana only, and CBD is abundant in hemp. Some of our older consumers had to be schooled on the distinct difference between hemp-derived CBD and pot. There’s no THC in our products and it is not pot! THC causes euphoria and other mind-altering effects, CBD doesn't. Not even a little bit.
      ...
      "2_2": (
        <div>
          ...
          >
            Most of our CBD products, especially the CBD Oils and the CBD Isolates are suitable for Vegans. The CBD softgel capsules contain some animal-derived nutrients: the gelatine shell is derived from bovine and are not meant for vegans.
      ...
      "2_3": (
        <div>
          ...
          >
         We would recommend you to ask your doctor or book a Consult with our CBD doctor.
          </LearnCollapsePlus>
          ...
          >
  Keep them in a cool, dry place, away from excessive heat, moisture, light and direct sunlight.
      ...
      "2_7": (
        <div>
          <p>
          CBD isolate contains 99+ percent CBD (essentially a purified form of CBD). It does not contain plant terpenes or any other plant compounds. CBD Isolate is flavorless and odourless because it doesn’t have the natural / plant flavour of CBD Oil. It’s to add to baked goods, beverages or sauces where you don’t want the CBD flavor.
{" "}
          </p>
      ...
      "2_8": (
        <div>
          ...
          <p>What are the benefits of MCT Coconut oil?
</p>
<p>MCT Coconut oil is well known to:
</p>
<ul>
            <li>Support weight loss by making you feel full
</li>
            <li>Help energy burning and ketone production
</li>
            <li>Improve your gut.</li>
            
          </ul>
<p>Additionally, MCT Coconut oil does not have a plant taste, so it’s great for those who don’t care for the ‘hemp’ taste in Hemp Seed Oil.</p>
        </div>
      ),
...
How should I take CBD softgel capsules? 
          ...
          >
           Swallow them with ease! Remember, ingesting CBD in a capsule form takes as long as 45 minutes to take effect. For some people, this is beneficial in terms of timing. Note: Gel capsules contain CBD oil inside a gelatin softgel which cannot be opened or divided, whereas a regular capsule can be pulled apart into two pieces exposing the CBD oil.
          </LearnCollapsePlus>
        </div>
      ),
      ...
      "2_13": (
        <div>
          <p>
          When CBD infused creams and gels are applied to your skin, the CBD has a positive impact because of the various properties of CBD. Our CBD Topicals contain many nourishing botanicals as well that are beneficial for your skin health.
          </p>
          <LearnCollapsePlus
            title="How should I apply CBD topicals? "
            onClick={() => {
          ...
          >
            Apply a small amount of the CBD creams on your body to see how you feel. Gradually increase the application amount over time.
          </LearnCollapsePlus>
          {/* <LearnCollapsePlus
      ...
      "3_7": (
        <div>
          ...
          >
           If a particular product or your package is missing or in case of any other questions, please contact us at customerservice@cbdbene.com. To expedite your request, please include your order number in the email.{" "}
          </LearnCollapsePlus>
          <LearnCollapsePlus
