    ...
    return (
        <Layout headerVersions={["bg-light"]} headerTheme="dark">
            <div className="c-privacy__page-title c-privacy__mt-85">
                <Heading versions={["large"]} parentClass="c-privacy" >SHIPPING & RETURNS</Heading>
            </div>
            {/* <MainForm/> */}
            <div className="c-privacy__content">
                ...
                <div className="container">
                    <p>Our packages are assembled by hand and processed within 24 to 48
                ...
                <div className="container">
                    <p>We ship to all 50 states in the U.S. as well as internationally to
                ...
                <div className="container">
                    <p>Once an order is placed a notification email is sent to your email
                ...
                <div className="container">
                    <p>Once your order leaves our warehouse, it is handled by a carrier
                ...
                <Heading versions={["large"]}>
                    ...
                    <p>Yes, please visit the “My Profile” section to update your shipping
                ...
                <div className="container">
                    <p>Unopened and unused product can be returned within 60 days of
