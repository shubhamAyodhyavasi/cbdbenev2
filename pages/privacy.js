...
const privacy = () => {
    ...
    The Site may contain links to other sites. This Privacy Policy does not apply to information collected on such third party sites and we are not responsible for the privacy practices of such third parties or the content of their sites.
                </div>
                <Heading>
                    Users Under the Age of 18
                </Heading>
                <div className="container">
                    The Site is intended for use by adults. Neither the Site nor the App is designed or intended to attract, and is not directed to, children under eighteen (18) years of age. No one under age 18 may provide any information to or on the Website, and no one under the age of 21 may register on the Website. We do not knowingly collect personal information from users under 18. If you are under 18, do not use or provide any information on the Website, or on or through any of its features, use any of the interactive or public comment features of the Website or provide any information about yourself to us, including your name, address, telephone number, email address, or any user name. If you are under the age of 21, you may not register with the Website, and thus may not make any purchases or access educational services through the Website. If we learn we have collected or received personal information from a child under 18 without verification of parental consent, we will will use reasonable efforts to refrain from further using such personal information or maintaining it in retrievable form. If you believe we might have any information from or about a child under the age of 18, please contact us at privacy@cbdbene.com.
                </div>
                <Heading>
                    Categories of Information Collected
                </Heading>
                <div className="container">
                    We may collect personal and non-personal information about you through the Site and/or the App.

    Information Collected through the Site and/or the App might include:
<ul>
                        <li>Name (first, last and/or middle) and username, Home contact information (e.g., billing and shipping addresses, email address, telephone number, fax number), date of birth, items purchased, password, zip/postal code or country, gender, date of birth, electronic signature, hobbies, interests.</li>
                        <li>Photographic or video image to the extent provided by you.</li>
                        <li>Medical history, including the results of any questionnaires, surveys, information requests, interviews, or other documentary, text, video, or audio interactions related to the provision of health services.</li>
                        <li>Service provider name and the date, time and content of any messages sent from you to us;</li>
                        <li>Internet connection, the equipment you use to access our Site and usage details;</li>
                        <li>Credit/debit card and other billing information;</li>
                        <li>Information regarding uses of the services; and</li>
                        <li>Other information that is automatically collected or that you choose to provide in any way, shape or form.</li>
                    </ul>
...
<ul>
                        ...
                        <li>With your express consent, your contacts and/or contact information (e.g., names, telephone numbers, addresses, email addresses, photos) stored on your mobile device; and/or</li>
                        <li>With your express consent, information about third-party software applications on your mobile device.</li>
                    </ul>
                </div>
                <Heading>
...
<li>Facilitate your use of the Site, the App and/or their respective products and/or services;</li>
                    <li>Send you communications like, for example, administrative emails, answers to your questions and updates about the Site and/or the App;</li>
                    ...
                    <li>Conduct research and measurement activities for purposes of product and service research and development, advertising claim substantiation, market research, and other activities related to the Site, the App and/or their respective products and/or services;</li>
    ...
    You may wish to visit http://www.networkadvertising.org/understanding-online-advertising/ to learn more about interest-based advertising and your choices regarding having this information used by third parties and your “opt out” choices. Opting out through the DAA or the NAI only means that those DAA or NAI members will no longer be able to deliver targeted content and/or ads to you, which will affect our Site as well as other unaffiliated sites, but does not mean you will no longer receive any targeted content and/or ads. Also, if your browsers are configured to reject cookies when you visit these opt out pages, or you subsequently erase your cookies, use a different computer or change web browsers, your opt out choices may not, or may no longer, be effective.
                ...
                <div className="container">
                    If you want to be removed from our marketing list and do not want us to send you e-mail, postal mail or other messages about our products and services, you can opt out. To do so, please send an e-mail tounsubscribe@cbdbene.com, with the word “REMOVE” in the subject line.
                ...
                <div className="container">
                    California Civil Code Section 1798.83 permits California residents to request certain information regarding our disclosure of such residents’ personal information to third parties for such third parties’ direct marketing purposes. To make such a request, please e-mail us at privacy@cbdbene.com.
                </div>
                <Heading>
    ...
    Finally, as explained further above, bené does not authorize third parties to collect your personal information when you use the Site or the App, except as expressly stated in this Privacy Policy. To the fullest extent permitted by law, bené is not responsible for, and you hereby release bené from any and all liability which may arise from, such third parties’ unauthorized collection of your personal information
                ...
                <div className="container">
                    If you have any questions or suggestions about this Privacy Policy, the Site or the App please contact us by e-mail: privacy@cbdbene.com
